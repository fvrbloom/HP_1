...
В данной практической работе изучаются основные элементы программирования на языке C++, включая работу с массивами, динамической памятью и базовыми структурами данных. Также проводится сравнение последовательных и параллельных алгоритмов с использованием технологии OpenMP.

Практическая работа состоит из трёх частей:

* работа с массивами и поиск минимального и максимального элементов;
* реализация базовых структур данных и операций над ними;
